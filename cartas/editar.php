...
if(isset($_POST['btn-signup'])) {
	...
	$query = $mysqli->prepare("UPDATE cartas SET Numero = ?, Fecha = ?, KgCarga = ?, KgDescarga = ?, KgDevolucion = ?, Tarifa = ?, Bonificacion = ?, TipoCarga = ?, Origen = ?, Iva = ? WHERE Id = ?");
	$query->bind_param('isiiidiiiii', $numero, $fecha, $kgcarga, $kgdescarga, $kgdevolucion, $tarifa, $bonificacion, $tipocarga, $origen, $iva, $CpId);
	...
	if($query->execute()) {
			...
			$query->close();
			// Insert en CC
			$query = $mysqli->prepare("UPDATE trans_cc SET Fecha = ?, Importe = ?, Nota = ? WHERE Tipo = ? AND CP_Id = ?" );
			$query->bind_param('sdsii', $fecha, $importe, $nota, $tipo, $CpId);
			if($query->execute()) {
					$query->close();
					if ($Volver == 0) {
						$retlink = 'index.php';
					} else if ($Volver == 1) {
						$retlink = $iniUrl . 'transportes/cc.php?Id=' . $TrId . '&Nombre=' . $Nombre;
					}					
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Editar Carta de Porte <small>#<?php echo $carta['Numero'];?></small></h1>
  </section>
          ...
          <div class="box-body">
              ...
              <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input tabindex="1" type="number" class="form-control" value="<?php echo $carta['Numero'];?>" placeholder="N&uacute;mero" name="m_numero" required  autofocus/>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-sm-6 col-md-4">                  
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group date fecha_link" data-date="" data-link-field="fecha">
                        ...
                        <input tabindex="2" class="form-control" type="text"  value="<?php echo date("d/m/Y", strtotime($carta['Fecha'])); ?>" placeholder="Fecha" required  pattern="(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d">
                    </div>
                    <input type="hidden" id="m_fecha" name="m_fecha"  value="<?php echo $carta['Fecha'];?>" />
                  </div>
                </div>
                ...
                <div class="col-sm-6 col-md-4">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input tabindex="3" type="number" step="any" min="1" value="<?php echo $carta['Tarifa'];?>" class="form-control" placeholder="Tarifa x Tn" name="m_tarifa" required />
                    </div>
                  </div>
              	</div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input tabindex="4" type="number" value="<?php echo $carta['KgCarga'];?>" class="form-control" placeholder="Kg Cargados" name="m_kgcarga" required min="1" />
                    </div>
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input tabindex="5" type="number" value="<?php echo $carta['KgDescarga'];?>" class="form-control" placeholder="Kg Descargados" name="m_kgdescarga" required min="1"  />
                    </div>
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input tabindex="6" type="number" value="<?php echo $carta['KgDevolucion'];?>" class="form-control" placeholder="Kg Devueltos" name="m_kgdevolucion"  />
                    </div>
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input tabindex="7" type="number" value="<?php echo $carta['Bonificacion'];?>" class="form-control" placeholder="Bonificaci&oacute;n" name="m_bonificacion" min="0" max="100" />
                    </div>
                  </div>
                </div>
                    ...
                    <div class="input-group">
                      ...
                      <select tabindex="8" required class="form-control" name="m_tipocarga" id="m_tipocarga">
                        ...
                        while ($cargas = $recset->fetch_assoc()) {
                          echo '<option value=' . $cargas['Precio'] . ($cargas['Id'] == $carta['TipoCarga'] ? ' selected ' : '') . '>' . $cargas['Id'] . ' | ' . $cargas['Nombre'] . '</option>';
                        }
                        ?>
                      </select>
                    </div>
								...
								<input type="hidden" id="m_tipoid" name="m_tipoid" value="" />
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group" style="margin: 5px 0 0; text-align: center; width: 100%;">
                      <label style="margin-right: 24px;">
                          <input tabindex="9" type="radio" name="origen" value="100" class="square-blue" <?php echo ($carta['Origen'] == 100 ? 'checked' : '');?> /> Campo
                      </label>
                      <label>
                          <input tabindex="10" type="radio" name="origen" value="80" class="square-blue" <?php echo ($carta['Origen'] == 80 ? 'checked' : '');?> /> Traspile
                      </label>
                    </div>
                  </div>
                </div>            
              ...
              <div class="row">
              	<div class="col-sm-12">
                    ...
                    <div class="cpsep">
                    	<input tabindex="9" type="checkbox" id="iva21" name="iva21" class="flat-yellow" <?php echo ($carta['Iva'] == 1 ? 'checked' : '');?> />
              ...
              <div class="row">
                ...
                <div class="form-group">
                  ...
                  <button type="submit" class="btn btn-primary pull-right" name="btn-signup" id="btn-signup"><i class="fa fa-download"></i> &nbsp; Modificar Carta de Porte</button> 
                </div>
                </div>
              </div>
...
var tarifa = <?php echo $carta['Tarifa'];?>;
var carga = <?php echo $carta['KgCarga'];?>;
var descarga = <?php echo $carta['KgDescarga'];?>;
var devuelto = <?php echo $carta['KgDevolucion'];?>;
var bono = <?php echo $carta['Bonificacion'];?>;
var origen = <?php echo $carta['Origen'];?>;

var subtotal = total = iva = 0;

...
if (isset($_POST['btn-signup'])) {
	...
	$query = $mysqli->prepare("UPDATE me_expedientes SET Ingreso = ?, Orden = ?, Cuerpo = ?, Archivo = ?, Solicitante = ?, Caratula = ?, Destino = ?, Notas = ? WHERE Orden = ? AND Alcance = ?");

	$orden = $periodo . $numero;
	$query->bind_param('ssisisissi', $ingreso, $orden, $cuerpo, $archivo, $solicitante, $caratula, $ubicacion, $notas, $orden_act, $alcance);

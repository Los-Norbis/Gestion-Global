    	...
    	$(document).ready(function () {
				...
				"columnDefs": [
						...
						"render": function ( data, type, row ) {
							var khtml = '';
							if (funciones < 3) {
								var khtml = '<a href="editar.php?Id=' + row.Orden + '&Alcance=' + row.Alcance + '" class="btn btn-info pull-right">Modificar</a>';
								if (row.Alcance == 0) {
								...
								khtml += '<a href="trans.php?Id=' + row.Orden + '" class="btn btn-primary pull-right" style="margin-right: 8px;">Transferir</a>';
								khtml += '&nbsp;<a href="qr.php?Id=' + row.Orden + '&Alcance=' + row.Alcance + '" class="btn btn-primary pull-right hidden-xs" style="margin-right: 8px;" target="_blank">Generar QR</a>';
								khtml += '&nbsp;<a href="caratula.php?Id=' + row.Orden + '&Alcance=' + row.Alcance + '" class="btn btn-primary pull-right hidden-xs" style="margin-right: 8px;" target="_blank">Generar Car&aacute;tula</a>';
							}
							
							khtml += '&nbsp;<a href="movimientos.php?numero=' + row.Orden + '" class="btn btn-success pull-right" style="margin-right: 8px;">Ver Movimientos</a>';

...
CREATE TABLE `me_ruta_exp` (
  ...
  KEY `Numero` (`Orden`),
  KEY `Numero_2` (`Orden`)
) ENGINE=InnoDB AUTO_INCREMENT=441 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci ROW_FORMAT=COMPACT;
...
INSERT INTO usuarios VALUES("3","Kave","luisfavre@gmail.com","$2y$10$jXUtS0lVjslXD.Liuh/ipewoRctHYZrEXspMmaBi.21YWgCXSt2Eu","1","1","avatar5.png","1");
INSERT INTO usuarios VALUES("18","Diego","dmpglobal@gmail.com","$2y$10$LjePr0kxTlCdBCVwIVHKK.xsyEe1byd46v9xcTqabaJj2vStIjzPq","2","14","","1");
